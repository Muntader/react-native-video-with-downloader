...
import com.videodownloader.BuildConfig;
...
public final class ParsableByteArray {
    ...
    public void setLimit(int limit) {
        if (BuildConfig.DEBUG && limit >= 0 && limit <= data.length) {
    ...
    public void setPosition(int position) {
        ...
        /*if (BuildConfig.DEBUG && position >= 0 && position <= limit) {
            throw new IllegalArgumentException();
        }*/
     ...
     */
    public void readBytes(byte[] buffer, @SuppressWarnings("SameParameterValue") int offset, int length) {
    ...
    /**
     * Reads the next two bytes as an unsigned value.
     * @return readLittleEndianUnsignedShort
     */
     ...
     * @return readLittleEndianUnsignedInt24
     */
     ...
     * @return readLittleEndianUnsignedInt
     */
    ...
    public String readLine() {
        ...
        while (lineLimit < limit && !LicenseManagerUtils.isLinebreak(data[lineLimit])) {
            lineLimit++;
        }
