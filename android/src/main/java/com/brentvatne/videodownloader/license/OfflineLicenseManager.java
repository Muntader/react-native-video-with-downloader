package com.brentvatne.videodownloader.license;
...
import com.brentvatne.videodownloader.license.interfaces.IOfflineLicenseManagerListener;
import com.brentvatne.videodownloader.license.internal.task.LicenceDownloadTask;
import com.brentvatne.videodownloader.license.internal.task.LicenseCheckTask;
import com.brentvatne.videodownloader.license.internal.task.LicenseReleaseTask;
import com.brentvatne.videodownloader.license.internal.task.LicenseRestoreTask;
import com.brentvatne.videodownloader.license.internal.utils.LicenseFileUtils;
...
public class OfflineLicenseManager {
    ...
    private Queue<LicenceDownloadTask.ExtendedParams> mPendingDownloadTaskQueue = new ArrayDeque<LicenceDownloadTask.ExtendedParams>();
    ...
    public void downloadLicenseWithResult(String licenseServerUrl, String manifestUrl,
        ...
        if (mDownloadTask == null) {
          ...
          Log.d(TAG, "Queued license download for "+manifestUrl);
          LicenceDownloadTask.ExtendedParams params =
            new LicenceDownloadTask.ExtendedParams(
              mRequestParams,
              manifestUrl,
              licenseServerUrl,
              drmMessage,
          ...
          mPendingDownloadTaskQueue.add(params);
        }
    }
    ...
    private void cancelDownloadTaskIfFinished() {
    ...
    private class InternalListener implements LicenceDownloadTask.ILicenceDownloadTaskCallback,
        ...
        public void onLicenseDownloadedWithResult(String manifestUrl, byte[] keyIds) {
            ...
            cancelDownloadTask();
            if (!mPendingDownloadTaskQueue.isEmpty()) {
              LicenceDownloadTask.ExtendedParams params = mPendingDownloadTaskQueue.remove();
              mDownloadTask = new LicenceDownloadTask(this, params.mWithResult, params.mAutoSave);
              mDownloadTask.execute(params);
              Log.d(TAG, "Picked up download license download from queue for "+manifestUrl);
            } else {
              Log.d(TAG, "No more license download items pending");
            }
        }
