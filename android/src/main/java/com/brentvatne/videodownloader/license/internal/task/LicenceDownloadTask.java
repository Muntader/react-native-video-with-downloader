package com.brentvatne.videodownloader.license.internal.task;
...
import com.brentvatne.videodownloader.license.internal.exception.LicenseManagerException;
import com.brentvatne.videodownloader.license.internal.model.DrmMessage;
import com.brentvatne.videodownloader.license.internal.model.Manifest;
import com.brentvatne.videodownloader.license.internal.model.SchemeData;
import com.brentvatne.videodownloader.license.internal.utils.DrmUtils;
import com.brentvatne.videodownloader.license.internal.utils.LicenseFileUtils;
import com.brentvatne.videodownloader.license.internal.utils.ManifestUtils;
import com.brentvatne.videodownloader.license.internal.utils.RequestUtils;
...
public class LicenceDownloadTask extends AsyncTask<LicenceDownloadTask.Params, Void, byte[]> {
    ...
    private byte[] getKeySetId(Params params) throws NotProvisionedException,
        ...
        int format = Util.inferContentType(Uri.parse(mManifestUrl));
    ...
    private void onError(Exception e) {
        Log.e(TAG, "License download failed with error:\n " + e.toString(), e);
    ...
    public static class ExtendedParams extends Params {
      ...
      public final boolean mAutoSave;

      public final boolean mWithResult;

      public ExtendedParams(Map<String, String> requestProperties, String manifestUrl,
                            String licenseServerUrl, String axDrmMessage,
                            String defaultStoragePath, long minExpireSecond, boolean withResult, boolean autoSave ) {
        super(requestProperties, manifestUrl, licenseServerUrl, axDrmMessage, defaultStoragePath, minExpireSecond);
        this.mAutoSave = autoSave;
        this.mWithResult = withResult;
      }
    }
}
